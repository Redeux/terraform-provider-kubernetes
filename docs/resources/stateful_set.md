...
- **type** (String, Optional) Indicates the type of the StatefulSet update strategy. Default is RollingUpdate
...
- **partition** (Number, Optional) Indicates the ordinal at which the StatefulSet should be partitioned. Default value is 0.
