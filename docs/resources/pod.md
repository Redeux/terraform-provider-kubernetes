...
<a id="nestedblock--spec--volume--csi--controller_expand_secret_ref"></a>
...
- **secret** (Block List) Secret represents a secret that should populate this volume. More info: http://kubernetes.io/docs/user-guide/volumes#secrets (see [below for nested schema](#nestedblock--spec--volume--projected--default_mode--secret))
